...
public class Main {
    ...
    public static void menu() {
        do {
            ...
            System.out.println("╚═════════════════════════════════════════╝");
            System.out.print("Opção: "); // Solicita a entrada do usuário
            opcao = entrada.nextInt(); // Lê a opção escolhida
            entrada.nextLine(); // Consumir quebra de linha

            // Switch para direcionar o usuário com base na escolha
            switch (opcao) {
                case 1 ->
                    menuCoordenador(); // Chama o menu específico para coordenadores
                case 2 ->
                    menuProfessor(); // Chama o menu específico para professores
                case 0 ->
                    System.out.println("Saindo..."); // Exibe mensagem de saída
                default ->
                    System.out.println("Opção inválida!"); // Trata opções não reconhecidas
            }
        } while (opcao != 0); // Repete o menu até que o usuário escolha sair (opção 0)
    }
